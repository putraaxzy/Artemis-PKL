                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-blue-700 text-sm">
                          Tugas Anda sedang direview oleh guru. Anda akan mendapatkan
                          notifikasi setelah dinilai.
                        </p>
                      </div>
                    </div>
                  </>
                  ...
                  {task.penugasan
                    ...
                    .map((penugasan) => (
                      ...
                      >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            {penugasan.tanggal_pengumpulan && (
                              <p className="text-xs text-gray-500 mt-1 flex items-center gap-1">
                                ...
                                {new Date(penugasan.tanggal_pengumpulan).toLocaleDateString("id-ID")}
                              </p>
                            )}
                          </div>

                          <div className="flex items-center gap-3">
                            <span className={`px-4 py-2 rounded-full text-xs font-bold shadow-sm flex items-center gap-1 ${getStatusColor(penugasan.status)}`}>
                              {penugasan.status === "selesai" ? (
                                <MdCheck className="w-4 h-4" />
                              ) : penugasan.status === "ditolak" ? (
                                <MdCancel className="w-4 h-4 text-gray-900" />
                              ) : null}
                              {penugasan.status.charAt(0).toUpperCase() + penugasan.status.slice(1)}
                            </span>
                        ...
                        {penugasan.status === "dikirim" && gradingPenugasanId === penugasan.id ? (
                          <div className="mt-4 pt-4 border-t border-gray-200 space-y-4">
                            ...
                            <div className="space-y-3">
                              <div>
                                ...
                                <select
                                  value={gradeStatus}
                                  onChange={(e) => setGradeStatus(e.target.value as "selesai" | "ditolak")}
